...
const Favorite = require('./controllers/favorites_controller');
...
app.get('/', requireAuth, function(req, res) {
    res.send({
        message: 'Super secret code is 123abc'
    });
});
...
app.get('/user/flashcardsets/favorites', requireAuth, Favorite.getFavorites);
app.post('/user/flashcardsets/favorite/add', requireAuth, Favorite.addFavorite);
app.post('/user/flashcardsets/favorite/remove', requireAuth, Favorite.removeFavorite);
